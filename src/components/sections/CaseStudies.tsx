...
const caseStudies = [
  ...
  },
  {
    ...
    challenge:
      "No digital presence, manual processes, limited reach in beauty industry",
    solution:
      "Built WordPress e-commerce website from scratch, managing and continuously optimizing for better performance",
    results: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Deep dive into projects where I've delivered measurable results and
            business value
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {caseStudies[activeCase].techStack.map((tech) => (
                      <span
                        key={tech}
                        className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-3 py-1 rounded-full text-sm"
                      >
                        {tech}
                      </span>
                    ))}
          ...
          <div className="relative">
            <div className="aspect-video bg-gradient-to-br from-green-900 to-emerald-900 rounded-xl overflow-hidden border border-gray-700">
              <div className="w-full h-full flex items-center justify-center">
                <div className="text-center text-white">
                  <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl flex items-center justify-center text-2xl mb-4 mx-auto">
                    📊
                  </div>
            ...
            <div className="absolute -top-4 -right-4 bg-green-500 text-white p-3 rounded-xl shadow-lg">
              <div className="text-sm font-bold">
                +{caseStudies[activeCase].results[0]?.match(/\d+/)?.[0] || "40"}
                %
              </div>
